<?php
	$contact = "网站首页:<a href='http://brobird.applinzi.com/article/index.php'>http://brobird.applinzi.com/article/index.php</a>";
	$contact .= "<br />";
	$contact .= "邮箱:<a href='mailto:defu_wei@foxmail.com'>defu_wei@foxmail.com</a>";
	$contact .= "<br />";
?>
